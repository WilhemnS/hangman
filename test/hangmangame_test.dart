...
void main() {
  ...
  group('Test Hangman Constructor', () {
    ...
    test('Function score() should initially be zero', (){
      //make a variable that we will use to pass to the constructor as our word
      String word = 'glorp';
      //pass word to game constructor and create object called hangmanGame
      final hangmanGame = HangmanGame(word);
      //expect that the score is 0 since we just started
  ...
  group("Test Scoring Logic", (){
    ...
    test('after a single correct guess', () {
      ...
      //Expect score to be 5 after a correct guess
      expect(hangmanGame.score(), 5);
    });

    test('after a single correct guess with multiple instances', () {
      //Start a game with the word banana
      String word = 'banana';
      final hangmanGame = HangmanGame(word);
      //Correct guess
      ...
      //Expect score to be 15 after a correct guess
    ...
    test('after a single incorrect guess', () {
      ...
      //Expect score to be -5 after a incorrect guess
      expect(hangmanGame.score(), -5);     
    });
    ...
    test('after multiple correct guesses', () {
      ...
      String word = 'banana';
      final hangmanGame = HangmanGame(word);
      //Correctly guess 2 letters
      hangmanGame.guess('b');
      hangmanGame.guess('a');
      //Expect score to be 20 after 2 correct guesses
    ...
    test('after multiple incorrect guesses', () {
      ...
      String word = 'banana';
      final hangmanGame = HangmanGame(word);
      //Incorrectly guess 2 letters
      hangmanGame.guess('x');
      hangmanGame.guess('y');
      //Expect score to be -10 after 2 incorrect guesses
    ...
    test('after all letters guessed', () {
      ...
      hangmanGame.guess('a');
      hangmanGame.guess('n');
      //Expect score to be 30 after guessing all letters
