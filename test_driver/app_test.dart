...
void main() {
  ...
  test(
    ...
    //At a new game the score should be 0
  ...
  test(
    ...
    //At a correct guess the score should be 5 since the word is longer than 5
  ...
  test(
    ...
    //With an incorrect guess and 2 correct guesses with 1 multiple instances 15 - 5.
  ...
  test(
    ...
    //I should see my final score on the win screen 30(correct) - 5(incorrect)
